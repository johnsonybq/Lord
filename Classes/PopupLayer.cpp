...
PopupLayer* PopupLayer::create(const char *backgroundImage, cocos2d::Size diagonSize)
{
    PopupLayer* layer = PopupLayer::create();
    
    layer->setSprite9BackGround(Scale9Sprite::create(backgroundImage));
    
    layer->m_dialogContentSize = diagonSize;
...
void PopupLayer::setContentText(const char *text, int fontsize, int padding, int paddingTop){
    ...
    m_contentPaddintTop = paddingTop;
}
...
void PopupLayer::backgroundFinish(){
    ...
    if (getLabelContentText()){
        ...
        ltf->setDimensions(CCSizeMake(m_dialogContentSize.width - m_contentPadding * 2, m_dialogContentSize.height - m_contentPaddintTop));
